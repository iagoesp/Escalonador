...
public class Frame implements CaretListener{
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(10, 10, 1350, 650);
...
//			t = jpanels.length;
//			for(int i = 0; i< t; i++) {
//				if(jpanels[i].okProcBT.isEnabled()==false) {
//					jpan = false;
//					break;
//				}
//				jpan = true;
...
//		}
		...
		if(proc.isEmpty()==false && !proc.equals("0")) procB = true;
		if(sobre.isEmpty()==false) sobreB = true;
		if(quant.isEmpty()==false && quant != "0") quantB = true;
